...
public class NDCStatus  implements java.io.Serializable {
    ...
    private com.decipherzone.rxcuindc.ws.NDCDate[] ndcdate;
    ...
    public NDCStatus(
           ...
           com.decipherzone.rxcuindc.ws.NDCDate[] ndcdate,
     ...
     * @return ndcdate
     */
    public com.decipherzone.rxcuindc.ws.NDCDate[] getNdcdate() {
        return ndcdate;
    }
     ...
     * @param ndcdate
     */
    public void setNdcdate(com.decipherzone.rxcuindc.ws.NDCDate[] ndcdate) {
        this.ndcdate = ndcdate;
    }
