...
public class DBManagerServiceLocator extends org.apache.axis.client.Service implements com.decipherzone.rxcuindc.ws.DBManagerService {
    ...
    public com.decipherzone.rxcuindc.ws.DBManager getRxNormDBService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.decipherzone.rxcuindc.ws.RxNormDBServiceSoapBindingStub _stub = new com.decipherzone.rxcuindc.ws.RxNormDBServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.decipherzone.rxcuindc.ws.DBManager.class.isAssignableFrom(serviceEndpointInterface)) {
                com.decipherzone.rxcuindc.ws.RxNormDBServiceSoapBindingStub _stub = new com.decipherzone.rxcuindc.ws.RxNormDBServiceSoapBindingStub(new java.net.URL(RxNormDBService_address), this);
                _stub.setPortName(getRxNormDBServiceWSDDServiceName());
                return _stub;
            }
        }
