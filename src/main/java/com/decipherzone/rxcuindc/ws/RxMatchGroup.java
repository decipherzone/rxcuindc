...
public class RxMatchGroup  implements java.io.Serializable {
    ...
    private com.decipherzone.rxcuindc.ws.RxMatchInfo[] rxMatchInfo;
    ...
    public RxMatchGroup(
           ...
           com.decipherzone.rxcuindc.ws.RxMatchInfo[] rxMatchInfo) {
     ...
     * @return rxMatchInfo
     */
    public com.decipherzone.rxcuindc.ws.RxMatchInfo[] getRxMatchInfo() {
        return rxMatchInfo;
    }
     ...
     * @param rxMatchInfo
     */
    public void setRxMatchInfo(com.decipherzone.rxcuindc.ws.RxMatchInfo[] rxMatchInfo) {
        this.rxMatchInfo = rxMatchInfo;
    }
